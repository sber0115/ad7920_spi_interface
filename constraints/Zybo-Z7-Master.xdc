...
##Clock signal
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { fpga_clk }]; #IO_L12P_T1_MRCC_35 Sch=sysclk
create_clock -period 8.00 [get_ports { fpga_clk }];
...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { start_sampling_btn }]; #IO_L24N_T3_34 Sch=btn[1]
...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { LED_5 }]; #IO_L18P_T2_34 Sch=led6_r
...
##Pmod Header JE                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { adc_sdata }]; #IO_L4P_T0_34 Sch=je[1]						 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { adc_sclk }]; #IO_L18N_T2_34 Sch=je[2]                     
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { adc_cs_L }]; #IO_25_35 Sch=je[3]                          
