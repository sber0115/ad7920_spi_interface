...
#
# spi_adc_project.tcl: Tcl script for re-creating project 'spi_adc_project'
#
# Generated by Vivado on Tue Jan 30 04:02:44 EST 2024
...
#
# 1. This project restoration tcl script (spi_adc_project.tcl) that was generated.
#
...
#
#    "/home/sebas/vivado_projects/spi_adc/rtl_srcs/spi_main.sv"
#    "/home/sebas/vivado_projects/spi_adc/rtl_srcs/top.sv"
#    "/home/sebas/vivado_projects/spi_adc/constraints/Zybo-Z7-Master.xdc"
#    "/home/sebas/vivado_projects/spi_adc/rtl_srcs/testbench.sv"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../rtl_srcs/spi_main.sv"]"\
 "[file normalize "$origin_dir/../rtl_srcs/top.sv"]"\
 "[file normalize "$origin_dir/../constraints/Zybo-Z7-Master.xdc"]"\
 "[file normalize "$origin_dir/../rtl_srcs/testbench.sv"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "spi_adc_project"
...
set script_file "spi_adc_project.tcl"
...
set file "$origin_dir/../rtl_srcs/spi_main.sv"
...
set file "$origin_dir/../rtl_srcs/top.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../rtl_srcs/testbench.sv"
set file [file normalize $file]
...
set_property -name "xsim.simulate.runtime" -value "3500" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/spi_adc_project.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/spi_adc_project.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/spi_adc_project.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
